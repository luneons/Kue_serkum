 ...
 <?php
    ...
    // Jika status update berhasil, kurangi stok produk
    if ($simpan == true) {
        // Ambil semua item di keranjang untuk mengurangi stok
        ...
        while ($item = $keranjang->fetch_object()) {
            ...
            // Kurangi stok produk
            $koneksi->query("UPDATE tb_produk SET stok = stok - $jumlah_dibeli WHERE produk_id = '$produk_id'");
        }
