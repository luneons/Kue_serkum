...
<head>
    ...
    <title>Produk Kue Ulang Tahun</title>
    <style>
        /* Preloader */
        #preloder {
            display: flex;
...
<section class="latest-products spad">
    <div class="container">
        ...
        <ul class="nav justify-content-center nav-pills mb-5">
            ...
            <li class="nav-item">
                <a class="nav-link" href="?page=pages/produk1">Kue Wedding</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="?page=pages/produk2">Kue Ulang Tahun</a>
            </li>
            <li class="nav-item">
        ...
        <div class="row" id="product-list">
            <?php
            $ambil = $koneksi->query("SELECT * FROM tb_produk WHERE produk_kat = 'Kue Ulang Tahun'");
